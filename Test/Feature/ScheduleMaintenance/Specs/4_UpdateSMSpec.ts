...
describe("Scheduled Maintenance", function () {
  ...
  afterAll(function () {
    console.log(">>>>>Test for Creating and updating new scheduled maintenance done<<<<<\n");
  ...
  it("Create and Update new scheduled maintenance", async function () {
    SMIndex.selectSite();
    let smCode = await SM.createAndReturnCompleteSMCode();
